...
class rvaFrameCallback {
 public:
  ...
  virtual void OnPluginFrame(std::unique_ptr<ics::analytics::AnalyticsBuffer> buffer) {};
};
...
class rvaPlugin {
  ...
  */
  virtual rvaStatus ProcessFrameAsync(std::unique_ptr<ics::analytics::AnalyticsBuffer> buffer) = 0;
  /**
